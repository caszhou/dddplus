...
public class ContainerTest {
    ...
    public void createLocalFile() throws Exception {
        URL jarUrl =
            new URL("https://github.com/funkygao/dddplus/blob/master/doc/assets/jar/order-center-bp-isv-0.0.1.jar");
        ...
        jarUrl = new URL(
            "https://github.com/funkygao/dddplus/blob/master/doc/assets/jar/order-center-bp-isv-0.0.1.jar?raw=true");
