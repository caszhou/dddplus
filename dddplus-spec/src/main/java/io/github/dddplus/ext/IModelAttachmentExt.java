 ...
 * </p>
 * <p>
 * Data extensions provide a mechanism for attaching arbitrary data to an interface to avoid bloat in core platform data
 * models.
 * </p>
 * 
 * <pre>
...
public interface IModelAttachmentExt<Model extends IDomainModel> extends IDomainExtension {
     ...
     *
     * @param source
     *            扩展属性数据的来源，从系统入参里获取 {@link RequestProfile#ext}
     * @param target
     *            把扩展信息传递到的目标领域模型
     */
     ...
     *            扩展属性数据的来源
     * @param target
     *            把扩展信息传递到的目标 {@link ApiResult#ext}
     */
