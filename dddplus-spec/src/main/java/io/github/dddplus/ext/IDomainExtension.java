 ...
 * </p>
 * <p>
 * This makes it so that extending teams can implement extension logic in an interface-driven way without modifying the
 * core code of the underlying platform.
 * </p>
 */
